...
def plots(root_file):
    parent = get_root_parent(root_file)
    ...
    for i in range(min(1000,mytree.GetEntries())):
        ...
        for j in range(507):
            ...
            energy = getattr(mytree, f"cell_{j}")
        ...
        pass
    xsegmentation.Draw()
    c.Print(f"{plot_folder}/tot_xprofil.pdf")
    sampling1_eta.Draw("colx")
    c.Print(f"{plot_folder}/tot_zy_layer1.pdf")
    sampling2_eta.Draw("colx")
    c.Print(f"{plot_folder}/tot_zy_layer2.pdf")
    gPad.SetLogz()
    ...
    for i in range(1,sampling3_eta.GetNbinsX()+1):
        for j in range(1,sampling3_eta.GetNbinsY()+1):
            ...
            pass
        pass
    c.Print(f"{plot_folder}/tot_zy_layer3.pdf")
    gPad.SetLogx(0)
    Fraction_in_thirdlayer.Draw()
    c.Print(f"{plot_folder}/Fraction_in_thirdlayer.pdf")
    Fraction_not_in.Draw()
    c.Print(f"{plot_folder}/Fraction_not_in.pdf")
    Shower_Depth.Draw()
    c.Print(f"{plot_folder}/Shower_Depth.pdf")
    Middle_lateral_width.Draw()
    c.Print(f"{plot_folder}/Middle_lateral_width.pdf")
    Front_lateral_width.Draw()
    c.Print(f"{plot_folder}/Front_lateral_width.pdf")
    Shower_Depth_width.Draw()
    c.Print(f"{plot_folder}/Shower_Depth_width.pdf")
